...
public class GenericFilter
   ...
   */
  public GenericFilter(AbstractExpression[] expressions) {
   ...
   * @param includeInactive 	whether to include inactive elements
   */
  public GenericFilter(AbstractExpression[] expressions, OrderBy[] order, boolean includeInactive) {
   ...
   * @return			itself
   */
  public GenericFilter addOrderBy(OrderBy orderby) {
    OrderBy[] 		orders;
    int			i;
