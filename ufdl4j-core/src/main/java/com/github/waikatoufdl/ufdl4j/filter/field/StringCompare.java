...
public class StringCompare
  extends AbstractCompareExpression<String> {
   ...
   */
  public StringCompare(String field, String value, Comparison comparison) {
   ...
   */
  public StringCompare(String field, String value, Comparison comparison, boolean invert) {
